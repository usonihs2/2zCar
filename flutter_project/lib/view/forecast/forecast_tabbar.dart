...
class _ForecastTabbarState extends State<ForecastTabbar>
  ...
  getJSONData() async {
    var url = Uri.parse(
        'http://192.168.45.31:8080/Rserve/rf_${Repository.modelPath}.jsp?year=${ForecastResult.year}&transmission=${ForecastResult.transmission}&fuel=${ForecastResult.fuel}&odometer=${ForecastResult.odometer}&drive=${ForecastResult.drive}');
